...
[`@aws-sdk/client-braket`](https://www.npmjs.com/package/@aws-sdk/client-braket/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-braket@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9/fvCt4np3CVx+pvhniCVYMjmK+Wabiup8m45WJaIRLcv06QtDVWMZviTAdcpVIE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-braket": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-braket@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-braket@3.8.0/index.min.mjs": "sha384-9/fvCt4np3CVx+pvhniCVYMjmK+Wabiup8m45WJaIRLcv06QtDVWMZviTAdcpVIE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-braket/blob/refs/tags/3.8.0/LICENSE
```
